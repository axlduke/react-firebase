...
import { annoucementInputs } from '../formSource'
...
const NewsEvents = () => {
    ...
    const handleAdd = async(e) => {
        ...
        try {
            ...
            await addDoc(collection(db, "annoucement"), {
                ...data,
            ...
            <div className="lg:ml-72 mt-14 lg:mt-10 2xl:mt-0 2xl:ml-52 mx-5 lg:mx-0 w-full h-screen">
                <div className="min-h-screen p-6 flex items-center justify-center">
                    <div className="container max-w-screen-lg mx-auto">
                        <div>
                        <h2 className="font-semibold text-xl text-gray-600">Annoucement Form</h2>
                        <p className="text-gray-500 mb-6">Form is to add new Annoucement Information.</p>
